                                    ...
                                    <div class="income-rate-total">
                                        <div class="price-adminpro-rate">
                                            ...
                                            if ($db->data("transaksi") != 0) {
                                                $pemasukan=0;
                                                foreach ($db->data("transaksi") as $masuk) {
                                                    $pemasukan += $masuk['total_bayar'];
                                                }
                                            }
                                            ?>
                                            <h3><span>Rp </span><span class="counter"><?php echo number_format($pemasukan,0,',','.'); ?></span></h3>
                                        </div>
                                ...
                                <div class="income-dashone-pro">
                                    <div class="income-rate-total">
                                        <div class="price-adminpro-rate">
                                            ...
                                            if ($db->data("barang") != 0) {
                                                $pengeluaran=0;
                                                foreach ($db->data("barang") as $keluar) {
                                                    $pengeluaran += $keluar['hrg_beli'];
                                                }
                                            }
                                            ?>
                                            <h3>Rp <span class="counter"><?php echo number_format($pengeluaran,0,',','.'); ?></span></h3>
                                        </div>
                                        <div class="price-graph">
                        ...
                        <div class="col-lg-3">
                            <div class="income-dashone-total visitor-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    <div class="income-rate-total">
                                        <div class="price-adminpro-rate">
                                            <h3>Rp <span class="counter">7888200</span></h3>
                                        </div>
                                        <div class="price-graph">
                        ...
                        <div class="col-lg-3">
                            <div class="income-dashone-total user-monthly shadow-reset nt-mg-b-30">
                                ...
                                <div class="income-dashone-pro">
                                    <div class="income-rate-total">
                                        <div class="price-adminpro-rate">
                                            <h3>Rp <span class="counter">88200</span></h3>
                                        </div>
                                        <div class="price-graph">
